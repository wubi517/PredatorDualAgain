...
import com.it_tech613.predator.apps.MyVideoView;
...
import static com.it_tech613.predator.apps.MyApp.is_video_played;
import static com.it_tech613.predator.apps.MyApp.num_server;
...
public class InitializeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    SelectLoginTypeDlg selectLoginTypeDlg;
...
//            Log.e("autho2",new String (Base64.decode(new String(Base64.decode(getThree().substring(12),Base64.DEFAULT)).substring(12),Base64.DEFAULT)));
        ...
        if (is_video_played) videoView.setVisibility(View.GONE);
        else {
...
//                            url="http://pelungoiptv.qhq.cc:25461/";
