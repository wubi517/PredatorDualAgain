package com.it_tech613.predator.ui.catchup;
...
import com.it_tech613.predator.models.CatchupModel;
...
//                        intent.putExtra("img",MyApp.selectedChannel.getImageURL());
        ...
        Observable<List<EPGEvent>> booksObservable =
    ...
    private List<EPGEvent> getEpg() {
        try {
            String response = MyApp.instance.getIptvclient().getAllEPGOfStream(MyApp.user,MyApp.pass,MyApp.selectedChannel.getStream_id()+"");
