package com.it_tech613.predator.ui.liveTv;
...
import com.it_tech613.predator.ui.WebViewActivity;
...
//    private int i = 0;
    ...
    private String rss="";
    private Runnable rssTicker,delayTicker;
...
//        mute.setOnClickListener(this);
        ...
        ly_audio_delay = view.findViewById(R.id.ly_audio_delay);
...
//            mute.setImageResource(R.drawable.sound);
            ...
            public void OnItemClick(Dialog dialog, int position) {
                ...
                switch (position) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        osdDlg = new OSDDlg(getContext(), delay_time / 1000, (dialog1, episode_num) -> {
                            if(mMediaPlayer!=null){
    ...
    private void playVideo() {
        ...
        if(MyApp.is_local){
            ...
            if(contentUri==null || contentUri.isEmpty() || contentUri.equalsIgnoreCase("null")){
                contentUri = MyApp.instance.getIptvclient().buildLiveStreamURL(MyApp.user, MyApp.pass,
                        MyApp.fullModels_filter.get(categoryPos).getChannels().get(playChanelPos).getStream_id()+"","ts");
            }
        }else {
