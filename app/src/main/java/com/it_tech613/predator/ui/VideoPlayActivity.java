...
import com.it_tech613.predator.models.PositionModel;
import com.it_tech613.predator.ui.movies.MediaDlg;
        ...
        if(positionModels==null || is_live){
            ...
            for(int i = 0;i<positionModels.size();i++){
                if(title.equals(positionModels.get(i).getTitle())){
                    position = i;
                    MediaDlg mediaDlg = new MediaDlg(VideoPlayActivity.this, new MediaDlg.DialogUpdateListener() {
                        @Override
...
//                                                current_resolution=which;
                                        ...
                                        break;
                                    case 4:
                                        osdDlg = new OSDDlg(VideoPlayActivity.this,  delay_time/1000, (dialog1, episode_num) -> {
                                            if(mMediaPlayer!=null){
                                                delay_time = episode_num*1000;
                                                mMediaPlayer.setAudioDelay(delay_time);
                                            }
