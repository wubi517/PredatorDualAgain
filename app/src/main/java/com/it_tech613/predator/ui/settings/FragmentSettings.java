package com.it_tech613.predator.ui.settings;
...
import com.it_tech613.predator.models.CategoryType;
import com.it_tech613.predator.models.Settings;
import com.it_tech613.predator.ui.LoginActivity;
import com.it_tech613.predator.ui.MainActivity;
import com.it_tech613.predator.ui.VpnActivity;
        ...
        settings_recyclerview.setAdapter(new SettingsAdapter(list, (position, settings) -> {
            switch (settings.getAction()){
                ...
                case "action_account"://User Account
                    AccountDlg accountDlg = new AccountDlg(requireContext(), new AccountDlg.DialogMacListener() {
                        @Override
