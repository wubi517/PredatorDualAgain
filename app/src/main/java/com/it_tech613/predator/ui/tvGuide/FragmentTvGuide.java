package com.it_tech613.predator.ui.tvGuide;
...
import com.it_tech613.predator.ui.ConnectionErrorActivity;
...
import com.it_tech613.predator.ui.liveTv.CategoryAdapter;
...
//            ((MainActivity)requireActivity()).toggleFullScreen(false);
        ...
        categoryAdapter = new CategoryAdapter(MyApp.live_categories_filter,  new Function3<CategoryModel,Integer,Boolean, Unit>() {
            @Override
