...
import com.it_tech613.predator.models.DataModel;
import com.it_tech613.predator.models.EPGEvent;
import com.it_tech613.predator.ui.movies.PackageDlg;
import com.it_tech613.predator.utils.OSDDlg;
...
import static com.it_tech613.predator.apps.Constants.catchupFormat;
...
public class LivePlayActivity extends AppCompatActivity implements  SeekBar.OnSeekBarChangeListener, IVLCVout.Callback,View.OnClickListener, IVLCVout.OnNewVideoLayoutListener, View.OnFocusChangeListener {
    ...
    SeekBar seekbar;
    LinearLayout ly_bottom, def_lay,ly_resolution,ly_audio,ly_subtitle,ly_fav,ly_audio_delay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ly_audio_delay.setOnFocusChangeListener(this);
    ...
    public void onFocusChange(View v, boolean focused) {
        switch (v.getId()){
            ...
            case R.id.ly_audio_delay:
                if(focused){
                    ly_audio_delay.setBackgroundResource(R.drawable.audio_delay_yell);
                }else {
                    ly_audio_delay.setBackgroundResource(R.drawable.audio_delay);
                }
                break;
            case R.id.ly_fav:
                if(focused){
...
//                                                current_resolution=which;
                                        ...
                                        break;
                                    case 4:
                                        osdDlg = new OSDDlg(LivePlayActivity.this, delay_time / 1000, (dialog1, episode_num) -> {
                                            if(mMediaPlayer!=null){
                                                delay_time = episode_num*1000;
                                                mMediaPlayer.setAudioDelay(delay_time);
                                            }
